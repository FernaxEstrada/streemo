...
-- Crea extensión, tablas, rol, privilegios y datos semilla
...
CREATE TABLE IF NOT EXISTS PlanPrincipal (
...
CREATE TABLE IF NOT EXISTS PlanCupo (
...
CREATE TABLE IF NOT EXISTS CupoVendido (
...
CREATE TABLE IF NOT EXISTS PagoCupo (
...
-- Seed idempotente de Persona/Usuario
DO $$
DECLARE
  v_idpersona uuid;
BEGIN
  ...
  IF v_idpersona IS NULL THEN
    ...
    INSERT INTO Persona (
      ...
      v_idpersona, 'Fernando', 'Achocalla Estrada', '67786830', 'M', TRUE, TRUE, TRUE, TRUE
    );
